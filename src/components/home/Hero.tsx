...
const Hero: React.FC = () => {
  return (
    <section className="pt-24 pb-16 md:pt-32 md:pb-24 relative bg-gradient-to-r from-blue-900 to-blue-700 text-white overflow-hidden">
      ...
      <div className="container-custom relative z-10">
        <div className="max-w-3xl mx-auto text-center">
          ...
          <p className="text-xl md:text-2xl mb-10 opacity-90 animate-fade-in">
            Join us in our mission to create opportunities and provide support for those who need it most in our community.
          </p>
