...
const Impact: React.FC = () => {
  return <section className="py-20 bg-gradient-to-r from-primary to-blue-700 text-white relative overflow-hidden">
      {/* Background overlay */}
      ...
      <div className="container-custom relative z-10">
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8 md:gap-12">
          <div className="bg-white/10 backdrop-blur-sm rounded-lg p-8 transform transition-transform hover:scale-105">
            <StatCard icon={<GraduationCap size={32} />} number="5,000+" text="Students Educated" />
          </div>
          
          <div className="bg-white/10 backdrop-blur-sm rounded-lg p-8 transform transition-transform hover:scale-105">
            <StatCard icon={<Heart size={32} />} number="10,000+" text="Medical Cases Supported" />
          </div>
          
          <div className="bg-white/10 backdrop-blur-sm rounded-lg p-8 transform transition-transform hover:scale-105">
            <StatCard icon={<Briefcase size={32} />} number="2,500+" text="Jobs Secured" />
          </div>
          
          <div className="bg-white/10 backdrop-blur-sm rounded-lg p-8 transform transition-transform hover:scale-105">
            <StatCard icon={<Users size={32} />} number="500+" text="Volunteers Engaged" />
          </div>
        </div>
      </div>
    </section>;
